meta:
  ...
  imports:
    ...
    # 1: IsoPlayer
    - iso_object/1_player
    # 2: IsoSurvivor (COMPLEX - has TODO placeholders)
    #- iso_object/2_survivor
    # 3: IsoZombie
    - iso_object/3_zombie
    # 4: IsoPushableObject
  ...
  - id: subclass_object
    ...
    type:
      ...
      cases:
        ...
        #2: survivor(context, world_version, debug)
        ...
        25: stone_furnace(context, world_version, debug)
...
instances:
  class_id:
    value: '(class_header.serialize == 1) ? class_header.class_id : 0'
  ...
  is_base_object_overridden:
    value: class_id < 0 or class_id == 6 or class_id == 27
  base_type:
