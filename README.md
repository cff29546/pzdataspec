...
This project aims to deliver a robust parser for Project Zomboid save files, enabling seamless integration with the `pzmap2dzi` project.
...
- **Downstream parsing tools**: Provide scripts and compiled parsers for users to easily parse game data and integrate with projects like `pzmap2dzi`.
...
- [Quick start: creating/updating data descriptions](docs/quick_start_data_description.md): how to use the `create_data_description` skill to derive `.ksy` specifications from decompiled game source.
